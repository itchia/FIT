...
$filename_detailRpt = ".\Azure-Billing_UsageData-Details_Month-$month-" + (Get-Date).ToString('yyyyMMddHHmmss') + ".csv"
$filename_priceRpt = ".\Azure-Billing_UsageData-Price_Month-$month-" + (Get-Date).ToString('yyyyMMddHHmmss') + ".csv"
$filename_summaryRpt = ".\Azure-Billing_UsageData-Summary_Month-$month-" + (Get-Date).ToString('yyyyMMddHHmmss') + ".csv"
